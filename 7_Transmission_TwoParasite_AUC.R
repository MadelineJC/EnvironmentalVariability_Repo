...
# To run this script, you'll need to download eight files from the link specified
...
# Outputs will be stored in "EnvironmentalVariability_Repo/Generated_Outputs".
