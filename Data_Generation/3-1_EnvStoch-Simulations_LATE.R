#### DOC STRING ===============================================================
# This script runs environmentally stochastic simulations in the low-average 
...
# and load the following files: 1-E_LT_Iden_PV.rds, 2-E_LT_Semi_PV.rds, 
# 3-E_LT_PiAd_PV.rds, 4-E_LT_PjAd_PV.rds.
#### END DOC STRING============================================================
...
saveRDS(List3, file = "Generated_Outputs/E_LT_Iden.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_LT_Iden_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_LT_Semi.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_LT_Semi_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_LT_PiAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_LT_PiAd_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_LT_PjAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_LT_PjAd_PV.rds")
