#### DOC STRING ===============================================================
# This script runs environmentally stochastic simulations in the high-average 
# temperature environment under each thermal scenario (Identical, Semi-Identical, 
# Pi-Advantage, and Pj-Advantage (Version A)). 
...
# and load the following files: 6-E_HT_Iden_PV.rds, 7-E_HT_Semi_PV.rds, 
# 8-E_HT_PiAd_PV.rds, 9-E_HT_PjAd_PV.rds.
#### END DOC STRING============================================================
...
saveRDS(List3, file = "Generated_Outputs/E_HT_Iden.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_HT_Iden_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_HT_Semi.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_HT_Semi_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_HT_PiAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_HT_PiAd_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/E_HT_PjAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/E_HT_PjAd_PV.rds")
