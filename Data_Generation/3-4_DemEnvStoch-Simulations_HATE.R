...
# in the high-average temperature environment under each thermal scenario 
...
# and load the following files: 6-DE_HT_Iden_PV.rds, 7-DE_HT_Semi_PV.rds, 
# 8-DE_HT_PiAd_PV.rds, 9-DE_HT_PjAd_PV.rds.
#### END DOC STRING============================================================
...
saveRDS(List3, file = "Generated_Outputs/DE_HT_Iden.rds")
...
saveRDS(List5, file = "Generated_Outputs/DE_HT_Iden_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/DE_HT_Semi.rds")
...
saveRDS(List5, file = "Generated_Outputs/DE_HT_Semi_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/DE_HT_PiAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/DE_HT_PiAd_PV.rds")
...
saveRDS(List3, file = "Generated_Outputs/DE_HT_PjAd.rds")
...
saveRDS(List5, file = "Generated_Outputs/DE_HT_PjAd_PV.rds")
